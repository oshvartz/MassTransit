...
namespace MassTransit.LibLogIntegration
{
    using Logging;
    ...
    /// <summary>
    /// Extensions for configuring LibLog with MassTransit
    /// </summary>
    public static class LibLogConfiguratorExtensions
    {
        /// <summary>
        /// Specify that you want to use the LibLog logging framework with MassTransit.
        /// </summary>
